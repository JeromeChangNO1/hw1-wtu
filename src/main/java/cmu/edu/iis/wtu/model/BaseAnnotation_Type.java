...
public class BaseAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("cmu.edu.iis.wtu.model.BaseAnnotation");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "cmu.edu.iis.wtu.model.BaseAnnotation");
  ...
  public float getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "cmu.edu.iis.wtu.model.BaseAnnotation");

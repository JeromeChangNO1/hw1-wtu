...
/** This is the representation of an answer.
...
public class Answer_Type extends Sentence_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("cmu.edu.iis.wtu.model.Answer");
  ...
  public boolean getIsCorrect(int addr) {
      ...
      jcas.throwFeatMissing("isCorrect", "cmu.edu.iis.wtu.model.Answer");
